...
public class runInput {
    ...
    public runInput(main_interface main_interface){
        ...
        OKButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int address = Integer.parseInt(decimalTextField.getText());
                main_interface.data.hardware.setPC(address);//refresh the interface in the stepRun function
                while(!main_interface.data.hardware.simulator_memory.memoryArray[main_interface.data.hardware.PC.value][2].equals("") && !main_interface.data.hardware.simulator_memory.memoryArray[main_interface.data.hardware.PC.value][2].equals("HLT")){
