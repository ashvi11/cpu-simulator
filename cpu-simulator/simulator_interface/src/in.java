...
public class in {
    ...
    public in(int num,main_interface main_interface){
        ...
        OKButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                main_interface.setRegisterValue(num,Integer.parseInt(decimalTextField.getText()));
                jFrame.dispose();
            }
        });
    ...
    public void setValue(String value){
        if(!value.equals("")){
            ...
            binaryTextField.setText(main_interface.data.hardware.intToString(16,result));
        }
    }
}
